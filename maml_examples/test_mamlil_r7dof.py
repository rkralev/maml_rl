...
# files[0], descriptions[0], step_sizes[0] = '/home/rosen/maml_rl/data/local/R7-IL-0624/R7_IL_200_40_1_1_dem40_ei5_as50_basl_2406_04_42/itr_22.pkl', "our_algo", 1.0 # out algorithm
# files[1], descriptions[1], step_sizes[1] = '/home/rosen/maml_rl/data/local/R7-IL-0624/R7_IL_200_40_1_1_flr0.0_dem40_ei5_as50_basl_2406_04_41/itr_0.pkl', "0_metaitr", 1.0  # randomly initialized baseline
# files[2], descriptions[2], step_sizes[2] ='/home/rosen/maml_rl/data/local/R7-IL-0624/R7_IL_200_40_1_1_flr0.0_dem40_ei5_as50_basl_2406_04_41/itr_21.pkl', "0_flr", 1.0  # 0 flr baseline
files[0], descriptions[0], step_sizes[0] = '/home/rosen/paper_ready_experiments/r7dof/mamltrpo/R7_TR_relu2x100.f1.0_051718_16_18/params.pkl', "trpo", 1.0   # MAML TRPO
...
n_itrs_list = [1,2,3,4,5]  # 1 through 4 grad steps
# all_avg_returns = []
for step_size, initial_params_file, desc in zip(step_sizes, initial_params_files, descriptions):
    ...
    for n_itr in n_itrs_list:
        ...
        for goalnum, goal in enumerate(goals):
            ...
            import csv
            with open('data/local/R7DOF-EVAL/'+exp_name+'/progress.csv', 'r') as f:
    ...
    if not os.path.exists('data/local/R7DOF-EVAL/mamlil'+desc):
        os.makedirs('data/local/R7DOF-EVAL/mamlil'+desc)
    with open('data/local/R7DOF-EVAL/summary_'+desc+'.csv', "w") as f:
