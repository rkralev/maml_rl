...
from sandbox.rocky.tf.policies.maml_minimal_gauss_conv_mlp_policy import MAMLGaussianConvMLPPolicy
...
from maml_examples.r7dof_env_vision_2distract import Reacher7Dof2DistractVisionEnv
...
goals_suffixes = ["_vision_2distr_dummy"] #,"_200_40_2", "_200_40_3","_200_40_4"]
# goals_suffixes = ["_1000_40"]

fast_batch_size_list = [1]  # 20 # 10 works for [0.1, 0.2], 20 doesn't improve much for [0,0.2]  #inner grad update size
meta_batch_size_list = [1]  # 40 @ 10 also works, but much less stable, 20 is fairly stable, 40 is more stable
                                            ...
                                            for fast_learning_rate in fast_learning_rates:
                                                for beta_steps, adam_steps in beta_adam_steps_list:
                                                    for bas in baselines:
                                                        ...
                                                        np.random.seed(seed)
                                                        rd.seed(seed)
                                                        env = TfEnv(normalize(Reacher7Dof2DistractVisionEnv()))
                                                        exp_name = str(
                                                            'R7_IL'
                                                        ...
                                                        algo = MAMLIL(
                                                            ...
                                                            policy=policy,
                                                            # policy=None,
                                                            # load_policy="/home/rosen/maml_rl/data/local/R7-IL-0828/R7_IL_vision_2distr_dummy_1nocorr_fbs1_mbs1_flr0.0_dem300_as1_basz_2808_21_39/itr_799.pkl",
